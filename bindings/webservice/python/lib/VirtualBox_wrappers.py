...
class IVirtualBox(IUnknown):
   ...
   def createLegacyMachine(self, _arg_name, _arg_osTypeId, _arg_settingsFile, _arg_id):
       ...
       req._id=_arg_id
       val=self.mgr.getPort().IVirtualBox_createLegacyMachine(req)
   ...
   def unregisterMachine(self, _arg_id):
       ...
       req._id=_arg_id
       val=self.mgr.getPort().IVirtualBox_unregisterMachine(req)
   ...
   def openHardDisk(self, _arg_location, _arg_accessMode, _arg_setImageId, _arg_imageId, _arg_setParentId, _arg_parentId):
       ...
       val=self.mgr.getPort().IVirtualBox_openHardDisk(req)
   ...
   def getHardDisk(self, _arg_id):
       ...
       req._id=_arg_id
       val=self.mgr.getPort().IVirtualBox_getHardDisk(req)
   ...
   def findHardDisk(self, _arg_location):
       ...
       req._location=_arg_location
       val=self.mgr.getPort().IVirtualBox_findHardDisk(req)
   ...
   def openDVDImage(self, _arg_location, _arg_id):
       ...
       req._location=_arg_location
       req._id=_arg_id
       val=self.mgr.getPort().IVirtualBox_openDVDImage(req)
   ...
   def getDVDImage(self, _arg_id):
       ...
       req._id=_arg_id
       val=self.mgr.getPort().IVirtualBox_getDVDImage(req)
   ...
   def findDVDImage(self, _arg_location):
       ...
       req._location=_arg_location
       val=self.mgr.getPort().IVirtualBox_findDVDImage(req)
   ...
   def openFloppyImage(self, _arg_location, _arg_id):
       ...
       req._location=_arg_location
       req._id=_arg_id
       val=self.mgr.getPort().IVirtualBox_openFloppyImage(req)
   ...
   def getFloppyImage(self, _arg_id):
       ...
       req._id=_arg_id
       val=self.mgr.getPort().IVirtualBox_getFloppyImage(req)
   ...
   def findFloppyImage(self, _arg_location):
       ...
       req._location=_arg_location
       val=self.mgr.getPort().IVirtualBox_findFloppyImage(req)
   ...
   def openRemoteSession(self, _arg_session, _arg_machineId, _arg_type, _arg_environment):
       ...
       val=self.mgr.getPort().IVirtualBox_openRemoteSession(req)
   ...
   def openExistingSession(self, _arg_session, _arg_machineId):
       ...
       req._session=_arg_session
       req._machineId=_arg_machineId
       val=self.mgr.getPort().IVirtualBox_openExistingSession(req)
   ...
   def registerCallback(self, _arg_callback):
       ...
       val=self.mgr.getPort().IVirtualBox_registerCallback(req)
   ...
   def unregisterCallback(self, _arg_callback):
       ...
       req._callback=_arg_callback
       val=self.mgr.getPort().IVirtualBox_unregisterCallback(req)
...
class IMachine(IUnknown):
   ...
   def attachDevice(self, _arg_name, _arg_controllerPort, _arg_device, _arg_type, _arg_id):
   ...
   def deleteSettings(self):
       ...
       val=self.mgr.getPort().IMachine_deleteSettings(req)
   ...
   def showConsoleWindow(self):
       ...
       return UnsignedLong(self.mgr,val._returnval)
   ...
   def getGuestProperty(self, _arg_name):
       ...
       return String(self.mgr,val._value), UnsignedLong(self.mgr,val._timestamp), String(self.mgr,val._flags)
   ...
   def enumerateGuestProperties(self, _arg_patterns):
       ...
       return String(self.mgr,val._name, True), String(self.mgr,val._value, True), UnsignedLong(self.mgr,val._timestamp, True), String(self.mgr,val._flags, True)
   ...
   def getIoBandwidthMax(self):
       req=IMachine_getIoBandwidthMaxRequestMsg()
       req._this=self.handle
       val=self.mgr.getPort().IMachine_getIoBandwidthMax(req)
       return  UnsignedInt(self.mgr,val._returnval)
   def setIoBandwidthMax(self, value):
       req=IMachine_setIoBandwidthMaxRequestMsg()
       req._this=self.handle
       if type(value) in [int, bool, basestring, str]:
            req._ioBandwidthMax = value
       else:
            req._ioBandwidthMax = value.handle
       self.mgr.getPort().IMachine_setIoBandwidthMax(req)
   ...
   _Attrs_={         'parent':[getParent,None],
         ...
         'ioBandwidthMax':[getIoBandwidthMax,setIoBandwidthMax,
        ]}
...
class IConsole(IUnknown):
   ...
   def forgetSavedState(self, _arg_remove):
       req=IConsole_forgetSavedStateRequestMsg()
       req._this=self.handle
       
       req._remove=_arg_remove
       val=self.mgr.getPort().IConsole_forgetSavedState(req)
   ...
   def registerCallback(self, _arg_callback):
       ...
       req._callback=_arg_callback
       val=self.mgr.getPort().IConsole_registerCallback(req)
   ...
   def unregisterCallback(self, _arg_callback):
       ...
       req._callback=_arg_callback
       val=self.mgr.getPort().IConsole_unregisterCallback(req)
...
class ISystemProperties(IUnknown):
   ...
   def getMaxVDISize(self):
       ...
       req._this=self.handle
       val=self.mgr.getPort().ISystemProperties_getMaxVDISize(req)
       return  UnsignedLong(self.mgr,val._returnval)
...
class IGuest(IUnknown):
   ...
   def getOSTypeId(self):
       ...
       return  String(self.mgr,val._returnval)
   def getAdditionsActive(self):
       req=IGuest_getAdditionsActiveRequestMsg()
       req._this=self.handle
       val=self.mgr.getPort().IGuest_getAdditionsActive(req)
       return  Boolean(self.mgr,val._returnval)
   ...
   def getPageFusionEnabled(self):
       req=IGuest_getPageFusionEnabledRequestMsg()
       req._this=self.handle
       val=self.mgr.getPort().IGuest_getPageFusionEnabled(req)
       return  Boolean(self.mgr,val._returnval)
   def setPageFusionEnabled(self, value):
       req=IGuest_setPageFusionEnabledRequestMsg()
       req._this=self.handle
       if type(value) in [int, bool, basestring, str]:
            req._pageFusionEnabled = value
       else:
            req._pageFusionEnabled = value.handle
       self.mgr.getPort().IGuest_setPageFusionEnabled(req)
   ...
   _Attrs_={         'OSTypeId':[getOSTypeId,None],
         'additionsActive':[getAdditionsActive,None],
...
class ISession(IUnknown):
   ...
   def close(self):
       ...
       val=self.mgr.getPort().ISession_close(req)
...
class IRemoteDisplayInfo:
    def __init__(self, mgr, handle, isarray = False):
       ...
       if isarray:
          ...
          self.bytesSent = UnsignedLong(self.mgr, handle._bytesSent)
       
          self.bytesSentTotal = UnsignedLong(self.mgr, handle._bytesSentTotal)
       
          self.bytesReceived = UnsignedLong(self.mgr, handle._bytesReceived)
       
          self.bytesReceivedTotal = UnsignedLong(self.mgr, handle._bytesReceivedTotal)
...
class IGuestOSType:
    def __init__(self, mgr, handle, isarray = False):
       ...
       if isarray:
          ...
          self.recommendedHDD = UnsignedInt(self.mgr, handle._recommendedHDD)
...
class SettingsVersion:
   ...
   _NameMap={0:'Null',1:'v1_0',2:'v1_1',3:'v1_2',4:'v1_3pre',5:'v1_3',6:'v1_4',7:'v1_5',8:'v1_6',9:'v1_7',10:'v1_8',11:'v1_9',12:'v1_10',13:'Future'}
   _ValueMap={
              'Null':0,
              'v1_0':1,
              'v1_1':2,
...
class MachineState:
   ...
   _NameMap={0:'Null',1:'PoweredOff',2:'Saved',3:'Teleported',4:'Aborted',5:'Running',6:'Paused',7:'Stuck',8:'Teleporting',9:'LiveSnapshotting',10:'Starting',11:'Stopping',12:'Saving',13:'Restoring',14:'TeleportingPausedVM',15:'TeleportingIn',16:'DeletingSnapshotOnline',17:'DeletingSnapshotPaused',18:'RestoringSnapshot',19:'DeletingSnapshot',20:'SettingUp',5:'FirstOnline',17:'LastOnline',8:'FirstTransient',20:'LastTransient'}
   _ValueMap={
              'Null':0,
              'PoweredOff':1,
              'Saved':2,
...
class HWVirtExPropertyType:
   ...
   _NameMap={0:'Null',1:'Enabled',2:'Exclusive',3:'VPID',4:'NestedPaging',5:'LargePages'}
   _ValueMap={
              'Null':0,
              'Enabled':1,
              'Exclusive':2,
